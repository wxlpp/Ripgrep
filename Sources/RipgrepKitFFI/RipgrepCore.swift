...
#if canImport(RipgrepCoreFFI)
    import RipgrepCoreFFI
#endif
...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_ripgrep_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    /// Frees the buffer in place.
    /// The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_ripgrep_core_rustbuffer_free(self, $0) }
    }
}
    ...
    CancelTokenProtocol
{
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_ripgrep_core_fn_clone_canceltoken(self.pointer, $0) }
    }

    public convenience init(timeoutMs: UInt64?) {
        let pointer =
            try! rustCall {
                uniffi_ripgrep_core_fn_constructor_canceltoken_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_ripgrep_core_fn_free_canceltoken(pointer, $0) }
    }

    open func cancel() {
        try! rustCall {
            uniffi_ripgrep_core_fn_method_canceltoken_cancel(self.uniffiClonePointer(), $0)
        }
    }

    open func isCancelled() -> Bool {
        return try! FfiConverterBool.lift(try! rustCall {
            uniffi_ripgrep_core_fn_method_canceltoken_is_cancelled(self.uniffiClonePointer(), $0)
        })
    }
}
...
public enum RipgrepError {
    ...
    @_documentation(visibility: private)
#endif
public struct FfiConverterTypeRipgrepError: FfiConverterRustBuffer {
    typealias SwiftType = RipgrepError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RipgrepError {
    ...
    public static func write(_ value: RipgrepError, into buf: inout [UInt8]) {
        switch value {
...
extension RipgrepError: Equatable, Hashable {}

extension RipgrepError: Foundation.LocalizedError {
...
public func searchBlocking(request: SearchRequest, cancel: CancelToken) throws -> SearchResult {
    return try FfiConverterTypeSearchResult.lift(rustCallWithError(FfiConverterTypeRipgrepError.lift) {
        uniffi_ripgrep_core_fn_func_search_blocking(
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_ripgrep_core_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if uniffi_ripgrep_core_checksum_func_search_blocking() != 62895 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ripgrep_core_checksum_method_canceltoken_cancel() != 15307 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ripgrep_core_checksum_method_canceltoken_is_cancelled() != 57624 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_ripgrep_core_checksum_constructor_canceltoken_new() != 14174 {
        return InitializationResult.apiChecksumMismatch
    }
