...
> - **P5..P7** pending (rename misnamed cancel test + Rust-side e2e [Swift layer already covers it — keep proportionate]; CANCEL_CHECK_EVERY/u32 [absorbs P2's latency lever]; extract lib.rs test modules).
>
